...
root = Tk()
canvas=Canvas(root,width=1600,height=1400)
...
lrLb = Label(root, text="DecisionTree", fg="white", bg="blue")
lrLb.grid(row=15, column=0, pady=10,sticky=W)

destreeLb = Label(root, text="RandomForest", fg="white", bg="blue")
destreeLb.grid(row=17, column=0, pady=10, sticky=W)

ranfLb = Label(root, text="NaiveBayes", fg="white", bg="blue")
...
t1 = Text(root, height=1, width=40,bg="blue",fg="black")
t1.grid(row=15, column=1, padx=10)

t2 = Text(root, height=1, width=40,bg="blue",fg="black")
t2.grid(row=17, column=1 , padx=10)

t3 = Text(root, height=1, width=40,bg="blue",fg="black")
